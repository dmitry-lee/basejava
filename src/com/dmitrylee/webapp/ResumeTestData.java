...
public class ResumeTestData {
    ...
    public static void fillData(Resume resume) {
        ...
        experience.add(new Organization("Java Online Projects", "http://javaops.ru/",
                Collections.singletonList(new Organization.Experience("Автор проекта.",
                        YearMonth.of(2013, 10),
                        YearMonth.now(),
                        "Создание, организация и проведение Java онлайн проектов и стажировок."))));

        experience.add(new Organization("Wrike", "https://www.wrike.com/",
                Collections.singletonList(new Organization.Experience("Старший разработчик (backend)",
                        YearMonth.of(2013, 10),
        ...
        education.add(new Organization("Coursera", "https://www.coursera.org/course/progfun",
                Collections.singletonList(new Organization.Experience("\"Functional Programming Principles in Scala\" by Martin Odersky",
                        YearMonth.of(2013, 3),
                        YearMonth.of(2013, 5), ""))));
        ...
        education.add(new Organization("Санкт-Петербургский национальный исследовательский университет информационных технологий, механики и оптики", "http://www.ifmo.ru/",
                Arrays.asList(new Organization.Experience("Аспирантура (программист С, С++)",
                                YearMonth.of(1993, 9),
                                YearMonth.of(1996, 7), ""),
                        new Organization.Experience("Инженер (программист Fortran, C)",
                                YearMonth.of(1987, 9),
                                YearMonth.of(1993, 7), ""))));
